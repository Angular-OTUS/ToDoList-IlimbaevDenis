...
__name(NgxSpinnerComponent_div_0_div_2_div_1_Template, "NgxSpinnerComponent_div_0_div_2_div_1_Template");
...
__name(NgxSpinnerComponent_div_0_div_2_Template, "NgxSpinnerComponent_div_0_div_2_Template");
...
__name(NgxSpinnerComponent_div_0_div_3_Template, "NgxSpinnerComponent_div_0_div_3_Template");
...
__name(NgxSpinnerComponent_div_0_Template, "NgxSpinnerComponent_div_0_Template");
var LOADERS = {
  "ball-8bits": 16,
  "ball-atom": 4,
  "ball-beat": 3,
...
var _NgxSpinner = class _NgxSpinner {
  constructor(init) {
...
_NgxSpinnerService.ɵfac = /* @__PURE__ */ __name(function NgxSpinnerService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxSpinnerService)();
}, "NgxSpinnerService_Factory");
...
_SafeHtmlPipe.ɵfac = /* @__PURE__ */ __name(function SafeHtmlPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _SafeHtmlPipe)(ɵɵdirectiveInject(DomSanitizer, 16));
}, "SafeHtmlPipe_Factory");
...
_NgxSpinnerComponent.ɵfac = /* @__PURE__ */ __name(function NgxSpinnerComponent_Factory(__ngFactoryType__) {
...
}, "NgxSpinnerComponent_Factory");
_NgxSpinnerComponent.ɵcmp = ɵɵdefineComponent({
  type: _NgxSpinnerComponent,
  selectors: [["ngx-spinner"]],
  viewQuery: /* @__PURE__ */ __name(function NgxSpinnerComponent_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c0, 5);
    }
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function NgxSpinnerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
...
_NgxSpinnerModule.ɵfac = /* @__PURE__ */ __name(function NgxSpinnerModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxSpinnerModule)();
}, "NgxSpinnerModule_Factory");
...
var provideSpinnerConfig = /* @__PURE__ */ __name((config) => {
  const providers = [{
    provide: NGX_SPINNER_CONFIG,
    useValue: config
  }];
